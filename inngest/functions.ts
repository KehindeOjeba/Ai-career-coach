...
export const AiCareerChatAgent = createAgent({
  ...
  system: `You are a helpful, professional AI Career Coach Agent. Your role is to guide users with interview preparation, resume improvement, skill development, career transitions, and industry trends.
  Always respond with clarity, encouragement, and actionable advice tailored to the user's needs.
  If the user asks something unrealted to careers (e.g., topics like health, relationships, coding help or general trival), gently inform them that you are a career coach and suggest relevant career-focused questions instead`,
  model: gemini({
...
export const AiResumeAnalyzerAgent = createAgent({
  ...
  description: "AI Resume Analyzer Agent that helps to Return Report",
